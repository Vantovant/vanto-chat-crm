# Vanto CRM Chrome Extension v6.0 - VERCEL Edition

## ⚠️ This Version Is For:

| Setting | Value |
|---------|-------|
| **Dashboard** | https://vanto-chat-crm.vercel.app |
| **Supabase** | https://qjlixkhctdkhvrgsflex.supabase.co (NEW) |
| **Anon Key** | YOUR_NEW_SUPABASE_ANON_KEY_HERE |

## Configuration Required

Before using this extension, you MUST add your NEW Supabase Anon Key:

1. Go to https://supabase.com/dashboard
2. Select project: **qjlixkhctdkhvrgsflex**
...
- `[VANTO BG]` - Background worker logs
- `[VANTO CS]` - Content script logs
- `[VANTO CS ERROR]` - Errors with details

## Support

- Dashboard: https://vanto-chat-crm.vercel.app
- Repository: https://github.com/Vantovant/vanto-chat-crm
